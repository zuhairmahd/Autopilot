function SendDeviceCommand ()
{
    ...
    Write-Host "Sending wipe command to device with ID $ManagedDeviceId"
    $params = @{
        keepEnrollmentData  = $false
        keepUserData        = $false
    }
    $response = Clear-MgDeviceManagementManagedDevice -ManagedDeviceId $ManagedDeviceId -BodyParameter $params -PassThru
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDIK/MOYzmlwiBM
# 3+IQiAEyqPnLriRZhGqUmLdl0Q/xbKCCIqYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# BgorBgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCA779l7N90mCIzO4t6Z9sFcuMtI
# IFxS+0KBl+QWNwIJ1TANBgkqhkiG9w0BAQEFAASCAYAOnc7fBpvsuWxosaoz2KiY
# X+BOgj/l4ikPSN/iN/ENrJtxjUKYm7mRxKFZf36m0XOqn5RsDJ5CV9mjeKgejTqn
# G6gNH1R7IXN+WbKDCzJ2wI9PxOUJ2iL86OHHLvlvYtUX5FSercdoq6ph56dWzPb6
# GZRXIQ3eZj8OilyzoQU/1CKnEEckqN33I17g6++8CVyip0K1Xn82ApCi3ovWltGC
# G+UfRUhhr62Orrm+31bKw8h+ltRTPAGk9N8KIzP/RC3VSOH7U+DKUhuecc1uy2um
# IoD0683pK3Rf8ev2n9TSl7G8N2V1Y8FBCCOhdEfxBpgXaMX/vBeW+9VgtX3U5hvE
# eTCqTpGbcF4tB0yl80pensLGmi/PiTSg4vV1W9js2oFSzgJEHtccWOxJ+GJrYL6K
# O0RGrUQmIxaRVW7KEUf+xByVS3ZK7869RFTxP7zoLKr3hf4pW9SZGFxw5biQvnyT
# vbXnDVdi4/wzzl0AiSzeoMevHnXXdTH3CgibXGlIIQ2hgheQMIIXjAYKKwYBBAGC
...
# MTANBglghkgBZQMEAgEFAAQgJCJbyB3YQC/Td1UuCv6SQTfdyMLAAvfAII5mCUez
# LTMCBmfO/UDxbhgTMjAyNTAzMTEwNTEwNTkuMjc1WjAEgAIB9KCB4KSB3TCB2jEL
...
# DQEJAzENBgsqhkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjUwMzExMDUxMDU5
# WjAvBgkqhkiG9w0BCQQxIgQg/mPyvNlAkxnyLQ0C3POGLrTXhwKG+XIYqIYu6fk+
# 7n0wgbkGCyqGSIb3DQEJEAIvMYGpMIGmMIGjMIGgBCBZKDgGu8T+xwIzm2AmYzwg
...
# vSUhcGwMkm0VdsIMr/pTMgYwDQYJKoZIhvcNAQEBBQAEggIAHSZBKmGeblUXwT5w
# xhoAReqibljgpnzznuVpq0fDqeSkFjTSbOHeIFL3oyAA/52zJn16zxhz0XCC3wD4
# y6gOhDhAD1ERihuwogGsPgN9iUFtU3r+xQeCfu9jt5LyIdWzMjf2flJ+9yj+B9Ir
# RWqSve6HU6AXBIlPaaeadN9qeHgmXIAp7cpa5INXSJwX9IG1Wavsxw6Uz9v1SYez
# c2nkxr8x9i5hZEadB28Vp1JOLeEkVe6voZJOvUBpS4LLny31pjkcUJfQ5e/1Vba6
# U0ygYAwGChxHU2lplDHyNcskNF4wluIZr7wj8bXIf5/vV8W8+31glbyyC85R9Cu8
# gk1GXKv2jjqhBA66dH5m80NBBxKHDLoRHYZMIQVBiVwFTipeNhWrID9QUXIbgsEX
# 0XT/OpnD4M3k8pUXvmOpqfsDnXBA/eka2GfAfVYB+KJi61kAnMzHTiBUOnITMnAL
# aHYANbWXJ+futFOy+apE4+FYP/T9TFoWKUpyG/WliSjs8AJxwTk+RixHkWcEEUZr
# SinKnnw6H4obwjcUvnCgSt30r0NViArgiGqGztxEG+CcxyEoR/qI/f3WkbZIpZQF
# h9CcogDjKyCj29wBj5qBDatmN6or/1u6X9ILXDDeYNDieM+71ue4/Tv1MmuUUi0x
# yfuM8FdoWXvh9pRLmsGS1FhsJ2k=
