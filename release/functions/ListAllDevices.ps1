function ListAllDevices ()
{
    ...
    foreach ($device in $devices)
    {
        ...
        Write-Verbose "Device type: $($device.deviceType)"
        $finalDeviceList += $device 
    }
    if ($finalDeviceList)
    {
        Write-Verbose "Returning $($finalDeviceList.Count) devices"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCY14VUqjYM68LM
# t+0/I+Lqpx33q00sySHHtbi9vABX5aCCIqYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# BgorBgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBCnkKEWK/+VWsCqXe9Vzo9oQuz
# /PeS5WUo54pehROuczANBgkqhkiG9w0BAQEFAASCAYAEwb17kwiyuUme+uWwvBHB
# 6H7VMCufIzzbL8VQp1qjUZzTam7pwOp9vxzc0KiiFkY8mxqkzxQjNFIsSIMVp59P
# V6VQPmz9TiMIPQdbTQd3/1zNloTael+86bMCX5A0VXcWJ8kRw6oTibt+7FqS3Edf
# FdH3XBl5SJCAWHeC9pO4Zdr5446bHrgnFbE0RkuyH2KowQEcs5CjRQqlJBlUQdN0
# R5o627oLhXwrhfNFPo/UVFx/r3NtdVbSZDF8dxHtj0VCMV27PTMUuMTZOTX//lPy
# H5W/tZJc9xfhLu+2hOnV7qj/lnYuc/2LPhJjVosXLS+ESS9ZABdEXllgmipw8d/g
# /IMcnHuU9tXlgzCIixIs+IEgt15L9ccn5sSi44tzgZc7OdNM46RTlT2vaDMuUtk+
# HCvFEchVglVVNOdC2WjDEodpiVSS/g3u0xBT9jLm5tKm1nMX/XCmimq65QrVJpL/
# dQ6JUWShTj2K4xHNutMy4wzCrMKmTwJSiGiTFy+1eHChghgUMIIYEAYKKwYBBAGC
...
# MTANBglghkgBZQMEAgEFAAQg+Mava3pgreHEESPpW/umS83hyZDyIRZ6A1Grgt3Y
# nlgCBmeXbGqvBhgTMjAyNTAzMTEwNTEwNTcuODA2WjAEgAIB9KCB4aSB3jCB2zEL
...
# NTdaMC8GCSqGSIb3DQEJBDEiBCBxNpJVRRjBmc3KVlUifZXUBzqV7t5v8EXGesWF
# vYecxTCBuQYLKoZIhvcNAQkQAi8xgakwgaYwgaMwgaAEINuJKJ0rsvRcScm4woZm
...
# 63nyLDAiGA8yMDI1MDMxMDIzMjAxMloYDzIwMjUwMzExMjMyMDEyWjB3MD0GCisG
# AQQBhFkKBAExLzAtMAoCBQDrefIsAgEAMAoCAQACAhMLAgH/MAcCAQACAhJyMAoC
# BQDre0OsAgEAMDYGCisGAQQBhFkKBAIxKDAmMAwGCisGAQQBhFkKAwKgCjAIAgEA
# AgMHoSChCjAIAgEAAgMBhqAwDQYJKoZIhvcNAQELBQADggEBACW7yc5a1vUDmHjx
# nQE2iP501Wz8XBIc7H2F/3NY4huAgX3RIQODBAzoPNuKZ9ngkwqCg31ZYz1FRVCb
# cyAOcXnU4nXSG3Icb4Kl1AJPwKj7AsUV05hKCp4C7NUBA6+3KrEw6S+V2ZJ/3WgA
# TYGcdEfwezaNQYUcBUS+n88s1B5uzs+6FXxiUv6Ml5dgruSdb/tvdv0UfqDAVoCM
# 1mdN7i13q9zB/XFkhmuqAmxu0BiTK+HcCA8ckt4r5q3PiNNm0W6SrRcswWT34UIt
# ErnSmibG4FFLqWTQ0qajminUtaDicZSkvOI6GlUkeTjcxohrcgpCBfa6MEbf/rdS
# 77dVmOIwDQYJKoZIhvcNAQEBBQAEggIAOd+Xmk44+lvMo3q4+5NWgcprJX1TqV1I
# 2Nh//8Yobpra6G7b4pJDzqbsMzvhNgQEObKwgLgXnptrm+70mRJHVPlKGIMD7Qrv
# T158FQUZzigQyxvxmkI7/cYb7HB3hDdDshjyK6ta7IoIuimRyX5680Gc9qoLgdGr
# t3HaRNyHhmkfb5c4k1r96yxI0f+6oi/RjhDms75FTnU+fCSYzA3WkPoeREOuL/pr
# IDLbvnEfBsRkuT/YJ7fau5PSrnBW56vlKxdjOSsvOOOpGYQK+BTkORruZiIbbAnV
# 1wdAc4nELkanKx9Vrq7urJSlzyIBzGg2FA6OE9s/2fDcHH8yIwF6qHd57pGLAy0R
# rkIUk+nKwbuQKfBrNwOSuwwnltycDyWYdV2RUjGLEP4Hvrob3mYVn/XVgs3trQEi
# 5kZfNbnj0nojzpm/dQ+WRugOlZ/Qp2jbv4JQy/rpeS9LYkXX3zQEwbtU2JkwNOpY
# Jr5Ztl5ENXVkmpQrG60iTMppTTUBTnA/mxAb/KG+Q5zxwOJDd/HEWuu41x4lf45j
# JPXYnubnW4jjFkfYc9X+WqXG3pgfYSbva37uIE6RYHaDSmdox1OApfXvySy+RYG2
# NKOTpaQZ4lg22X02YBNqr9mALUZd1xD3PVue61TEMHTBZgrikYVVLGPDWf49CcOH
# ApTKrCv3vzo=
