...
.DESCRIPTION
    Unit tests for repository information settings editor wrapper.
    ...
    Context "Wrapper Functionality" {
        ...
        It "Should call Show-SettingsEditor with correct SettingsType" {
            ...
            Mock -CommandName Show-SettingsEditor -MockWith {
                ...
                # Verify parameters
                $SettingsType | Should -Be 'repoInfo'
                return $true
            }
            
            # Call the wrapper
            $result = Show-RepoInfoEditor -SettingsFile "test.psd1"
        ...
        It "Should pass SettingsFile parameter to Show-SettingsEditor" {
            ...
            Show-RepoInfoEditor -SettingsFile "custom-settings.psd1"
