...
$scriptPath = "$driveLetter\Scripts"
...
Write-Host "Required module(s): $checkedModulesCount" -ForegroundColor Green
Write-Host "module(s) requiring installation: $installedModulesCount " -ForegroundColor Green
...
if (Test-Path $scriptName)
{
    if (-not($check))
    {
        ...
        else
        {
            ...
            #ask if the user wants to reboot the device.
            $reboot = Read-Host 'Do you want to reboot the device now? (Y/N)'
            if ($reboot -eq 'Y')
            {
                Write-Host 'Rebooting the device.' -ForegroundColor Green
                Restart-Computer -Force
            }
            else
            {
                Write-Host 'Remember to reboot the device to start the device enrollment.' -ForegroundColor Green
            }
        }
    }
    else
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCvbHInauxtETMU
# pPc0bSSEo21aZPbZ7Ebr+Q1vFxMSIqCCIqYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# BgorBgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCD1F2zkcvsfzEj78hemElQYPCwA
# 1WW6FUaxHDNpGL2WDjANBgkqhkiG9w0BAQEFAASCAYB943USLoDl2sDuoaQERuyr
# pesa0zMMrTI9syG8XFYfjtoLloXLmDiBLLRyf8/dGPkqMduKPm4GEh9Hf3xqqUbv
# Y8tKH9QRv9OtkgfZE9DJZbJAGTL6eabdbhYojmIG/nF6jD352aZGDQUlR+golF0L
# 4KN1TFKnDPn16obhRzupjaXPwMrjHtZN7QYXf3QkynoJRZCltHax0HgoHhvbs3X4
# gxOZyRX821jFVlZChYTjKehCqAeeVBBy53uryvmOZxrOMJbBdn/ZueUUiuewKzo9
# z6AMahzy1IDO46QyswBwgfI+rk8P4hDRppCN8nQzJ2QiTC4YOIAxuINMqrHCH6uy
# f0R/XOB0OfF1PlhFv47+riuCe96U7jOoHGsNG2rJCp39WfrYJqVksSrdEsyd6/s2
# 3z94Bsbjr96rubtKIPRtY0i05iGvMAoQgJsmEq6EMBNWx5rdhfIINDXyhJ6c7Ns2
# cGLtnbubjQmOFrnruk65atpxM28xUwGtFf2RjE9ZiZWhghgRMIIYDQYKKwYBBAGC
...
# MTANBglghkgBZQMEAgEFAAQg0CU9wP5Jh7NN9qQ7wsm0GHCngWB0TUhcyJJUaxxx
# sTwCBmeXbBJCUhgTMjAyNTAyMTQwMzM1MDUuMDk1WjAEgAIB9KCB4aSB3jCB2zEL
...
# hvcNAQkDMQ0GCyqGSIb3DQEJEAEEMBwGCSqGSIb3DQEJBTEPFw0yNTAyMTQwMzM1
# MDVaMC8GCSqGSIb3DQEJBDEiBCA3k9sz349ALP0SJwDmac0jVRcTUI3ptA7ZOByd
# e/7RETCBuQYLKoZIhvcNAQkQAi8xgakwgaYwgaMwgaAEINuJKJ0rsvRcScm4woZm
...
# zcEwDQYJKoZIhvcNAQEBBQAEggIAj5aR4jcijVs0G84g43CFkBKFFvYskiEMgX00
# GFSbhOxCD54+Tqw/iheXnK1orogBbGnjJKhb9TDTTAhcGtOJTCdE62jNynwov+tw
# Nck0z6o4nzS1ZWkb/u6foHb5YavGY83E2Tk8wRVJSu4LVvPNLEuu11oMVgMwGM8H
# GlD5HxUg4cV0QjBGmUvYohdixeJ0+DFdXJ462ncTyPSWKi5zXAg/a9pOj+umWypU
# pyH9yzCp9RJ0zGhxw4bKdnPji6jqGv7LJ3EgGIL/NDRjEl7zre8fMrPAsVrLnlVA
# aNBbbxyJ0FKqIpCHXHGaO6wULLj7+UaJAPhIWgjvmHl+APNIYFe775aJmDe7gdi5
# jnne3LQWCQdfs0sH9ceyZJH4Pff1XVj61PHs3FaPj+qUGeNnKrn5Witmheg88Z7y
# Fv3pKQ5OUDHiOcF+jQO/yLCnKOWcyYKNlGjDuU3YnzMauNHDILE203y8Klcnpwrt
# 9kOX1V8GXVSjhbhaj1EDVOrV/Vz5HpHpWInZ0GxL+yakZ5OM3/txxakG6qdpYxOV
# tY+Y75/Iu5dy1Dxz9GYrzxUBAWKQVv4ibkwh7oVWCWSdHTYVFQQGDVMpNCkV7v9c
# UO+WHXlYaTi/BfCvQbbv64Ju1vRY/+iAQkvAZl+dBYa0beF+70FkFOAkhEX8zbED
# P+XrtJc=
