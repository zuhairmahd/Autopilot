...
#region run export list test
do
{
    Write-Host "Choose 1 to export assigned device reports"
    Write-Host "Choose 2 to export unassigned device report"
...
#endregion run export list test
