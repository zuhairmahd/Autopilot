...
{
    Write-Host " Loading configuration values from $Configuration."try
    ...
    foreach ($key in $configData.PSObject.Properties.Name)
    {
        ...
        if ($PSBoundParameters.ContainsKey($key) -eq $false -and $null -ne $configData.$key)
        {
            ...
            {
                Write-Host "Read parameter $key from the configuration file as $($configData.$key)"
                $key = [bool] $configData.$key
            }
            else
            {
                Write-Host "Read parameter $key from the configuration file as $($configData.$key)"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDWSKSEStW56WwJ
# l4MeA8QuiZLgJvCDgaE2LoK04lj1o6CCIqYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# BgorBgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCD0QIov04+8tPk85koUX1gjNT9E
# 2qcuhAlmpNiZnN6l0zANBgkqhkiG9w0BAQEFAASCAYBwyCXEqUb1NoB2T4Nn7nHY
# IBjMJowLL/0BYFcywzo0Ax1DJskFBecAq1gj0C9mPMMDddApha39HHfEqbX6Z1n0
# 79G/QgxsBBznB6ErQh4ntT5kZGoIQhArJyOSzY/xCeMUxdvp3oIwvpxqJXCNJJdF
# gUBCa3Uk+W1NOoHH7HUI0Zx0nnLPld/8Q0//wgaeAz5ZiNEVxJTMW9tYfQY7ZAUX
# yEmA4+pxIvmePvf7NuP7x8Q8/YMOmxiPRDEr3gHw0fsU02jVbB88BqIi/9VblZkG
# vAllaunonHY5DkA4BbD7wJXXa3wfKMDq2HgcA04igD2XypaOx7jVpDTTk03X7+T+
# IFexGQftay39UmQhNYuIc+6stPcVLdHCG+jgf0wRc3uJIrjQfw+X9pJGWCpvR50y
# rRkKzs5ZVwkeB3uYYbIsY9Kt75sRXTNg9WxWBgyTE1f4FnArcpvMMJ4osOxbDnzF
# OSN3VOeGyWB/G0NufieWz6y8H6SRCYdVVa4UJAdiQPehgheQMIIXjAYKKwYBBAGC
...
# MTANBglghkgBZQMEAgEFAAQgEs8UYrJti6jRnGL/W6Gis0EdbPdzd8+OEmGwJ18v
# nscCBmfYCqEQSxgTMjAyNTAzMzExNzI1MjYuNjk0WjAEgAIB9KCB4KSB3TCB2jEL
...
# DQEJAzENBgsqhkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjUwMzMxMTcyNTI2
# WjAvBgkqhkiG9w0BCQQxIgQgget2Jx8ddJGPH9seAPPchFOQMPmATzGTxRAC1MZz
# VIgwgbkGCyqGSIb3DQEJEAIvMYGpMIGmMIGjMIGgBCBZKDgGu8T+xwIzm2AmYzwg
...
# aWMgUlNBIFRpbWVzdGFtcGluZyBDQSAyMDIwMA0GCSqGSIb3DQEBBQUAAgUA65T9
# 0TAiGA8yMDI1MDMzMTExNDEwNVoYDzIwMjUwNDAxMTE0MTA1WjB3MD0GCisGAQQB
# hFkKBAExLzAtMAoCBQDrlP3RAgEAMAoCAQACAhNXAgH/MAcCAQACAhIkMAoCBQDr
# lk9RAgEAMDYGCisGAQQBhFkKBAIxKDAmMAwGCisGAQQBhFkKAwKgCjAIAgEAAgMH
# oSChCjAIAgEAAgMBhqAwDQYJKoZIhvcNAQEFBQADgYEA0wDtmbmfSSaGpA86+f14
# sdOpjL3s/oReP1YllW0ZQzj9Y5NWjHHk+Al+r2w5QAIHn3TuSbtrp0b6IOSx/17r
# /Yri3kOTMd0+VXeTih0bUkw6otJrRoqakFctc4QFE+KAggSLgymVJNhVRE8gsoD5
# ESTMR1NVYnYglY3ChrMRFUwwDQYJKoZIhvcNAQEBBQAEggIAHqsfFf3FUnWPP3YV
# dMIUSNfYqirV+O7WndRT1+090ginwQr2ydvCuFfcCGbvET69OmnRVpUIdcwecngy
# cobefA1U6VsN7JNmCUbO/r8TooZq9ropMHr0cc5INfJ9+7Rz3aEPCSRW+LiwT2vV
# MO/eOAFBQPmezsuBtPQYBV72xdXrv1npy/7WtR5/jGgHie10BivaW8hdoXaxftN2
# hFjiJYFEKpDk6NqBlc/p0cGSoGn3zh+T1fIG7FOtZSaVHvsYoEyCG9whvurI/ceQ
# XzmiIm0pGAvWx+trVdX0+LjikQIovJz6+lxqD9MK3YVnzm4e2l+7o94K2atXDbtl
# xIpownf1GWjEiLwSm1xkpwPfIFl291VC0AqImBhjj444fOeJkPj3ckcfbTr8jUXy
# x+OR54A8lTz8+Kfy8M8zswcOwLotohBtklTYkfZP4TJzOlyirzaf58R4p/kqGlDC
# OlLAfD0H3hitcMjzF3Fs6VHTYmgXo6CmvX9Gsw6t8mEonS1lRSRjHH+qALkPKWD1
# qk+hkcKlo4ssjK23EdS5XsVFA06pO2oIhK7o4GtGYDWLTrxol+HLRBmzPXO/nBFT
# lMApbgv2J0wlw4FYS8ne3jK9QCPPGr5KeCrj+TNxd65lCrJTqt681C0SsH3b/4tj
# QqLu2fntQ5gcjYn+5o6aR4SUH1g=
