...
# Load the function
. (Join-Path $RepoRoot "functions/UserAndGroupFunctions/GetGroupDirectAssignments.ps1")
...
Write-Host "`n4. Calling GetGroupDirectAssignments..." -ForegroundColor Yellow
$result = GetGroupDirectAssignments -AccessToken $token -GroupName $testGroup -IncludeBeta
