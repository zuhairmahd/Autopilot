...
(
    ...
    $current.Remove("lastModifiedDateTime")
    $current.Remove("createdDateTime") 
    $current.Remove("@odata.context")
    $current.Remove("id")
    $current.Remove('managementServiceAppId')
    $current.Remove("roleScopeTagIds")
