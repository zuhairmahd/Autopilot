# region Generated 
  ...
  $null = Import-Module -Name (Join-Path $PSScriptRoot './bin/Microsoft.Graph.Identity.DirectoryManagement.private.dll')
  ...
  $customModulePath = Join-Path $PSScriptRoot './custom/Microsoft.Graph.Identity.DirectoryManagement.custom.psm1'
  ...
  if($instance.ProfileName) {
    if(($directories | ForEach-Object { $_.Name }) -contains $instance.ProfileName) {
      ...
      $exportsPath = $null
      Write-Warning "Selected Microsoft Graph profile '$($instance.ProfileName)' does not exist for module 'Microsoft.Graph.Identity.DirectoryManagement'. No cmdlets were loaded."
    }
  ...
  if($profileDirectory) {
    Write-Debug "Loaded Microsoft Graph profile '$($profileDirectory.Name)' for module 'Microsoft.Graph.Identity.DirectoryManagement'"
  ...
  $instance.Init();
  Write-Debug "Loaded Module 'Microsoft.Graph.Identity.DirectoryManagement'"
# endregion

# SIG # Begin signature block
# MIIoRgYJKoZIhvcNAQcCoIIoNzCCKDMCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDVSdzkdnoXrsGs
# SPkFzrEVj/jzijYmwlyQqbc8xd/PN6CCDXYwggX0MIID3KADAgECAhMzAAAEBGx0
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIIBWXrUoWqoddU3ZZJIkKiD3
# 5vkkqOTOh3m/Z6kPFT1UMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAlWD649ZGe4SKVNLPrTRBSGIz470aEyih/qFllyc6wmYytP5senh6uWlU
# jgMu72BFvp0AiHI600SuvRixs2hBdLkk/oZzw2w7DLOGp6gKmtXcKePmb9XIygpW
# uePMHpi+PDBIe3h61jupPc+RaadYI4FtH0Gqam3L5LmsBm1SQdZ5F/osiFHFA+Ri
# 8fzW/dsexdUByA8HqmGMt911RjooxKRSqQ+HP37vIwO440/iwSiSfpYUJMlaorQl
# HSm7gj9Cfu5R4Efz9M2wr3MhEb7Cx8cDN2u1MFxCCwW//Q9XJLY2nO/GBhxCBBmx
# q9LWFBDy2z3Xb3KQt7jPeODp0REtnKGCF7AwghesBgorBgEEAYI3AwMBMYIXnDCC
# F5gGCSqGSIb3DQEHAqCCF4kwgheFAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFaBgsq
# hkiG9w0BCRABBKCCAUkEggFFMIIBQQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCDP+plCBwfGDlkbneSgToRutpfdXRu6Zp9/xzJi5nCMeQIGZzvEHGPi
# GBMyMDI0MTEyMDE2NTg1Mi40OTJaMASAAgH0oIHZpIHWMIHTMQswCQYDVQQGEwJV
...
# CSqGSIb3DQEJAzENBgsqhkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQg5UZruZ9A
# ax3xB5iKsRn/lCVt6Fi8s5yiYTq0fsegTu8wgfoGCyqGSIb3DQEJEAIvMYHqMIHn
...
# DQEBCwUABIICAKMaGap8P2dIU8vjwq/ozKijOetXmwsa26AAzro66KwpLbmxBh1l
# 7q0TX51OiKjraaxFHPiBO3KEX/LFFmNPNYXUaGgOJ9pB0r3TSnFOgJhVaKO7aaOI
# 4bqbfQqaQVeYw1xsSL+JvhddJHEcBn9bw6I97sO3G12vHBOkGw2++Z783ttp6/Hj
# IxEml5S7jqURr37icwdYnCX8gaGnekMfBQ88wazbRUw5S2skDxIpf8VwpoK6h+uA
# YEwj/e++ZSal+PEBPOF494TfXETlXn77dzwz/JtB5B9hiNr3Pgznib6HrZjdeCRE
# NbwIw7RW4/jM+JvVtt19y7aO1gRq+TCNTprDpRsevMCkXkoc8d6cJVrpNTuGZiQu
# lRYYSnPM8X8kNeSPoX7W5NzBqNcO/pgKpyf8JzighibCtnWGLl3XdbpOGDm8ghYK
# 14zTbjgz/T/AbMFgpwgPcDmCZhu/Ouhpoq/S3So7dnVuLYCmGF+nIZZV4Vce8nW8
# CZ7cnbmTCAW8EeZRELvQxY8QD0eig5TCUZdlTgB0gY1BmYYVFOgoMjp86Tz1+HYb
# 8Nx8MEf/VObplK5KDuhW6ZqYJxJwMFPF2DTEeEoPiL0rS52NS93bTokhZ+ujuw3R
# s9RZ06Y1yaySTkn02B2CoOnmB+FIi1biehDJKDBdnDbSne0pffatHRXm
