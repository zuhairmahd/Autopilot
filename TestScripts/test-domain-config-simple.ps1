...
try {
    ...
    $loadedConfig = Load-DomainConfiguration -DomainName "testdomain.com" -ConfigurationPath $testContext.TestFolder
    ...
    if ($saveResult) {
        ...
        # Verify the save
        $verifyConfig = Load-DomainConfiguration -DomainName "testdomain.com" -ConfigurationPath $testContext.TestFolder
    ...
    $newDomainConfig = Load-DomainConfiguration -DomainName "newdomain.com" -GlobalSettings $testSettings.globalSettings -ConfigurationPath $testContext.TestFolder
