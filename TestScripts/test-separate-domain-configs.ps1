...
try
{
    ...
    if ($testDomainConfig)
    {
        Write-TestResult "Get-DomainConfigurationFromFiles created new domain configuration" $true
    ...
    {
        Write-TestResult "Get-DomainConfigurationFromFiles failed to create new domain" $false
    }
