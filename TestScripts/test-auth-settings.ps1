...
Write-Host "Test-AuthDefaults available: $($null -ne $testAuthDefaultsCmd)" -ForegroundColor Yellow
Write-Host "Get-AuthDefaults available: $($null -ne $getAuthDefaultsCmd)" -ForegroundColor Yellow
Write-Host "Show-SettingsEditor available: $($null -ne $showSettingsEditorCmd)" -ForegroundColor Yellow
Write-Host "Update-Setting available: $($null -ne $updateSettingCmd)" -ForegroundColor Yellow
...
try
{
    ...
    if ($getAuthDefaultsCmd)
    {
        ...
        if ($authDefaults)
        {
            ...
            if ($authDefaults.authType -and $authDefaults.scope)
            {
