function Get-AutopilotEventAnalysis()
{
    ...
    if ($uniqueUPNs.Count -gt 0)
    {
        ...
        try
        {
            ...
            Write-Verbose "[$functionName] Batch API call completed: successCount=$($batchResponse.successCount), failureCount=$($batchResponse.failureCount)"
