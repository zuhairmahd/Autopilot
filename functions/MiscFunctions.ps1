...
function DisplayUserList()
{
    ...
    else
    {
        ...
        $userMenu = NewMenu -Title "Select a user" -Description "User $userName could not be found. Did you mean:"
        ...
        Write-Verbose "[$functionName] Returning valid selected user: $selectedUser"
        return $selectedUser
    }
    else
    {
