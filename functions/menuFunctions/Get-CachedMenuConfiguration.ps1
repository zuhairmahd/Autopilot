    ...
    if ($needsReload) {
        ...
        try {
            ...
            if ($menuConfig) {
                ...
                Write-Verbose "[$functionName] Menu configuration cached successfully"
                Write-Log -LogFile $LogFile -Module $functionName -Message "Menu configuration cached successfully" -LogLevel "Debug"
            }
            else {
                Write-Verbose "[$functionName] Failed to load menu configuration"
        ...
        Write-Verbose "[$functionName] Using cached menu configuration"
...
function Clear-MenuConfigurationCache()
{
    ...
    $functionName = $MyInvocation.MyCommand.Name
    Write-Verbose "[$functionName] Clearing menu configuration cache"
