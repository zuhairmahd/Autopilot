function TestScriptUpdates()
{
    ...
    foreach ($key in $scriptVersionRemote.PSObject.Properties.Name)
    {
        $remoteScriptName = $key
        Write-Verbose "Checking for updates for $remoteScriptName"
        $remoteScriptVersion = [System.Version]::new($scriptVersionRemote.$remoteScriptName)
        Write-Verbose "Remote version: $remoteScriptVersion"
        if ($scripts.PSObject.Properties.Name -contains $remoteScriptName)
        {
            $localScriptVersion = [System.Version]::new($scripts.$remoteScriptName)
            Write-Verbose "Local version: $localScriptVersion"
            if ($localScriptVersion -lt $remoteScriptVersion)
            {
                Write-Verbose "$remoteScriptName needs to be updated to version $remoteScriptVersion"
                $scriptsToUpdate.Add($remoteScriptName, $remoteScriptVersion)
            }
        }
        else
        {
            Write-Verbose "$remoteScriptName is not present locally and needs to be added."
            $scriptsToUpdate.Add($remoteScriptName, $remoteScriptVersion)
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCR3k5OZI/yK0U+
# n7sLuMgUDMIsDV/UGGe5pCBg3o9L8aCCIqYwggXMMIIDtKADAgECAhBUmNLR1FsZ
...
# BgorBgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDkjUm837XZuoMdjro9AA50MXkN
# XccCO4ynOMp5Ng7AQTANBgkqhkiG9w0BAQEFAASCAYBgiYbNT1yvDZVl7aRgCs/V
# HwNO9S0OLTLLZ59+0LuAK0f/996bZQ3AXnCD4ae39FxWodGmz3N/tYzRcHArl13i
# 9bl0jJgAxYacJ6JjnVzasACHHL9GxowgVZYv1hNPc5bQuTClWPwNE7GwAqii2yRy
# 8nOVPWNs4BJBO5bbYjW5FqAEv8MX4AlwcF+O5rnIN1RJzlcjAKzh0WQyvWsmOxFA
# CJEk1oTDe6wGR95HjZGiO0WHaxbYItTgscNiYy4L10tcUyGbCUNynzqVTT30+gJV
# pd3RcSMieg+XgULb9XeoK56onxY4a4tz2m34rmG8PAuuxo7DnKjv2vdLP1xUxNTX
# IJEj6EElaenoFK1fJHlRADOah5Tv0vqeHxYeCxtzG68bhhpTWpJiX95Lpd8E183U
# vz8WKHX0EOwlgxGY8+79T5KYTnT3SCDWEI15Af5ACxFs81FNlWZDCep5sKklxheP
# WR0JuzSnH4rg3Fd/ztGYr43+roh6la+YMo3Wfp+PugyhghSgMIIUnAYKKwYBBAGC
...
# MTANBglghkgBZQMEAgEFAAQgtqhpD1rZBMha0zb6KJqj91phpjIUtDSrRl/KTCd8
# RNgCBme2dZfLaRgTMjAyNTAyMjgwNDA0MDIuNDA0WjAEgAIB9KCB4KSB3TCB2jEL
...
# MC8GCSqGSIb3DQEJBDEiBCA/xDBoICVUqxDYDTA/q3KMlFEe1mUSoyhLjLehLDO0
# sjCB3QYLKoZIhvcNAQkQAi8xgc0wgcowgccwgaAEILgEVTrIyIo/ceMv5rhPHM70
...
# BIICAJs6NGJ7wCcilkRD1fFvYBLi58j49218tV8yLRLqQrGSNygmrxyEULFrwVNh
# YchXWdGh4y2Dg/oHhqhxU3ztWkhMd3f/Ff4JHLSxG5+7ASRCD4Dlu77f447IOYjZ
# wHpFRC2PTcpCVmeucxqToD/otBQmHZOIAfHWv//21hG/t53li1urmoQdwRzt/BxZ
# qfaSSkNpCfcZZ6luAiB7qpBlnsWmyKTZPKUc/MLUtpYBZbZq/0NUnm2Qfu9JUUYg
# PC6FX+oTq0IpSelHUcXvXTnpnxT9D7Z81XKi5AkJt/MLgA3JpnsSL0LquZ64T9hN
# RoXa4Nh0le9OmMH+uqS+EV6RyNdDXYMKN+45Bq927UQvEPpCaFHxfigoODu1Y7Q4
# W2tFmLNexbWeGD5A8XT5FZSaHyAfpPNUyidRqzY8Cg5awlPpjgxmFcBvBloautv/
# 6L3vNCwHtEdNiRcGyJxWTx/0Rq+ObgoX9QhyFNACkUSYwX8+7ZbqiXHscfWtRAIq
# U0ZJN66zKZt2/xeZwHT85cqvx2A0+NewQZBXpHNukxHpKmBJGyqyu/D+g8LCFAWV
# p1/nbVCbNJzmeXt9FBehdHvQD0o/xXMwDYAcUDmh5B22j2teJRx1cgiZwhiy/Yd+
# 8Fp5XWtzbRXluiU0MWEeAE2GpqsS6cctHyIeEbUchFS1oqo2
