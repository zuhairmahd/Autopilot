    ...
    $defaults = [ordered]@{
        ...
        Strings           = [ordered]@{
            ...
            returnValues  = @{
                ...
                noAutopilotEventsFoundMessage      = "No Autopilot enrollment events found in the specified date range."
                ...
                noValidAutopilotEventsFoundMessage = "No valid Autopilot enrollment events found in the specified date range."
